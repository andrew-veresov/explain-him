...
REQUIRED = ("", "PRODUCT-CONTRACT.md", "assets/app.mjs", "assets/styles.css", "runtime/workspace.mjs", "runtime/webmcp.mjs", "runtime/generated/explain-him-native-skill.mjs", "tools/generate_native_skill.py", "explain-him.yaml", "schemas/explanation-block.v1.schema.json", "schemas/webmcp-explain.v5.schema.json", "knowledge/01-originator-flow.md", "resolutions/2026-08-30-user-consumer-terminology.md", "resolutions/2026-09-02-webmcp-protocol-v5-single-explain-tool.md", *SKILLS)
MARKERS = {
    "index.html": (b"andrew-veresov/explain-him", b"skills/explain-him/SKILL.md", b"skills/explain-him-presentation/SKILL.md", b"353008c867aa42cce4767a89fed934b1718e2307", b"explain_tool", b"For additional information, inspect the GitHub repository linked to this page.", b"ba4276347eb79dbde1566d71c1a68027094716a33d69b51d6d26951ac9cadb9c", b"data-eh-block-id=\"workflow-diagram\"", b"data-scroll-section=\"how-it-works\"", b"data-scroll-section=\"how-to-express\"", b"Ask your agent how to express your own idea with Explain Him.", b"http-equiv=\"origin-trial\""),
    ...
    "runtime/webmcp.mjs": (b"WEBMCP_PROTOCOL_VERSION = 5", b"explain_tool", b"353008c867aa42cce4767a89fed934b1718e2307", b"GROUNDING_SOURCE_INDEX", b"originator-publishing", b"cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659", b"PRODUCT-CONTRACT.md", b"ae24fe78b681c406180a78d017ba34a07e5ec587a8c6447a72e07f577dc3a263", b"ADDITIONAL_INFORMATION", b"allowedOperations", b"registerSkill(EXPLAIN_HIM_NATIVE_SKILL)"),
    "runtime/generated/explain-him-native-skill.mjs": (b"Generated by tools/generate_native_skill.py", b"explain_him", b"experimental-open-backlog", b"ba4276347eb79dbde1566d71c1a68027094716a33d69b51d6d26951ac9cadb9c"),
    "tools/generate_native_skill.py": (b"SOURCE_COMMIT = \"353008c867aa42cce4767a89fed934b1718e2307\"", b"document.modelContext.registerSkill", b"experimental-open-backlog", b"pinned-remote-fallback"),
    "runtime/workspace.mjs": (b"explain-him-local-workspace.v4",),
    "explain-him.yaml": (b"repository: andrew-veresov/explain-him", b"entrypoint: skills/explain-him/SKILL.md", b"entrypoint: skills/explain-him-presentation/SKILL.md", b"release: A9", b"native_skill:", b"proposal_status: experimental-open-backlog", b"ba4276347eb79dbde1566d71c1a68027094716a33d69b51d6d26951ac9cadb9c", b"groundingSourceIndex", b"topic: originator-publishing", b"knowledge/01-originator-flow.md", b"PRODUCT-CONTRACT.md", b"ae24fe78b681c406180a78d017ba34a07e5ec587a8c6447a72e07f577dc3a263", b"state_model: transactional-typed-presentation-operation-log", b"- explain_tool"),
    ...
    while pending:
        ...
        try:
            ...
            if key == "runtime/webmcp.mjs":
                ...
                record["tool_names"] = tool_names; record["exact_tool_names"] = tool_names == ["explain_tool"]
            ...
            if key == "runtime/webmcp.mjs" and not record.get("exact_tool_names"): errors.append("runtime/webmcp.mjs: registered tool names are not exactly explain_tool")
