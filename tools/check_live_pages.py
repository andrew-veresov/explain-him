...
REQUIRED = ("", "PRODUCT-CONTRACT.md", "assets/app.mjs", "assets/styles.css", "runtime/workspace.mjs", "runtime/webmcp.mjs", "runtime/generated/explain-him-native-skill.mjs", "tools/generate_native_skill.py", "explain-him.yaml", "schemas/explanation-block.v1.schema.json", "schemas/webmcp-context.v4.schema.json", "schemas/webmcp-explain.v4.schema.json", "knowledge/01-originator-flow.md", "resolutions/2026-08-30-user-consumer-terminology.md", *SKILLS)
MARKERS = {
    "index.html": (b"andrew-veresov/explain-him", b"skills/explain-him/SKILL.md", b"skills/explain-him-presentation/SKILL.md", b"59167103ebfb7d4fd0c276de7f2b81862c536b4f", b"get_explain_him_context", b"explain_tool", b"For additional information, inspect the GitHub repository linked to this page.", b"fc0b3bf222ad485d82bc6a0e05a5bb6130d8cdba06b2550d4475daa265271d36", b"data-eh-block-id=\"workflow-diagram\"", b"data-scroll-section=\"how-it-works\"", b"data-scroll-section=\"how-to-express\"", b"Ask your agent how to express your own idea with Explain Him.", b"http-equiv=\"origin-trial\""),
    ...
    "assets/app.mjs": (b"registerWebMcpTools", b"webmcpProtocol", b"webmcpNativeSkillState", b"webmcp-page-status"),
    "runtime/webmcp.mjs": (b"explain-him-webmcp-context.v4", b"get_explain_him_context", b"explain_tool", b"59167103ebfb7d4fd0c276de7f2b81862c536b4f", b"GROUNDING_SOURCE_INDEX", b"originator-publishing", b"cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659", b"PRODUCT-CONTRACT.md", b"24acbad739ead8781ad2918a227e5670ca9bdbf464088e5de530a29ae63a1c3c", b"ADDITIONAL_INFORMATION", b"allowedOperations", b"registerSkill(EXPLAIN_HIM_NATIVE_SKILL)"),
    "runtime/generated/explain-him-native-skill.mjs": (b"Generated by tools/generate_native_skill.py", b"explain_him", b"experimental-open-backlog", b"fc0b3bf222ad485d82bc6a0e05a5bb6130d8cdba06b2550d4475daa265271d36"),
    "tools/generate_native_skill.py": (b"SOURCE_COMMIT = \"59167103ebfb7d4fd0c276de7f2b81862c536b4f\"", b"document.modelContext.registerSkill", b"experimental-open-backlog", b"pinned-remote-fallback"),
    "runtime/workspace.mjs": (b"explain-him-local-workspace.v4",),
    "explain-him.yaml": (b"repository: andrew-veresov/explain-him", b"entrypoint: skills/explain-him/SKILL.md", b"entrypoint: skills/explain-him-presentation/SKILL.md", b"release: A8", b"native_skill:", b"proposal_status: experimental-open-backlog", b"fc0b3bf222ad485d82bc6a0e05a5bb6130d8cdba06b2550d4475daa265271d36", b"groundingSourceIndex", b"topic: originator-publishing", b"knowledge/01-originator-flow.md", b"PRODUCT-CONTRACT.md", b"24acbad739ead8781ad2918a227e5670ca9bdbf464088e5de530a29ae63a1c3c", b"state_model: transactional-typed-presentation-operation-log", b"- get_explain_him_context", b"- explain_tool"),
    ...
    while pending:
        ...
        try:
            ...
            if key == "runtime/webmcp.mjs":
                source = result.body.decode("utf-8", errors="strict")
                surface = re.search(r"EXPLAIN_HIM_WEBMCP_TOOLS\s*=\s*Object\.freeze\(\[([^\]]+)\]\)", source)
                tool_names = re.findall(r"'([^']+)'", surface.group(1)) if surface else []
                record["tool_names"] = tool_names; record["exact_tool_names"] = tool_names == ["get_explain_him_context", "explain_tool"]
            ...
            if key == "runtime/webmcp.mjs" and not record.get("exact_tool_names"): errors.append("runtime/webmcp.mjs: registered tool names are not exactly get_explain_him_context and explain_tool")
