...
class LivePagesSmokeTest(unittest.TestCase):
    def materialize(self, root: Path, extra_root: str = '') -> None:
        content = {
            ...
            'runtime/webmcp.mjs': "export const EXPLAIN_HIM_WEBMCP_TOOLS = Object.freeze(['explain_tool']); WEBMCP_PROTOCOL_VERSION = 5 59167103ebfb7d4fd0c276de7f2b81862c536b4f GROUNDING_SOURCE_INDEX originator-publishing cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md 24acbad739ead8781ad2918a227e5670ca9bdbf464088e5de530a29ae63a1c3c ADDITIONAL_INFORMATION allowedOperations registerSkill(EXPLAIN_HIM_NATIVE_SKILL)",
            ...
            'schemas/webmcp-explain.v5.schema.json': '{}',
            'resolutions/2026-09-02-webmcp-protocol-v5-single-explain-tool.md': '{}',
