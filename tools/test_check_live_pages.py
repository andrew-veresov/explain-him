...
class LivePagesSmokeTest(unittest.TestCase):
    def materialize(self, root: Path, extra_root: str = '') -> None:
        content = {
            ...
            'assets/app.mjs': "import '../runtime/workspace.mjs'; registerWebMcpTools(); webmcpProtocol webmcpNativeSkillState webmcp-page-status",
            'assets/styles.css': 'body { color: #111; }',
            'runtime/workspace.mjs': 'explain-him-local-workspace.v4',
            'runtime/webmcp.mjs': "export const EXPLAIN_HIM_WEBMCP_TOOLS = Object.freeze(['get_explain_him_context', 'explain_tool']); explain-him-webmcp-context.v4 59167103ebfb7d4fd0c276de7f2b81862c536b4f GROUNDING_SOURCE_INDEX originator-publishing cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md 24acbad739ead8781ad2918a227e5670ca9bdbf464088e5de530a29ae63a1c3c ADDITIONAL_INFORMATION allowedOperations registerSkill(EXPLAIN_HIM_NATIVE_SKILL)",
            'runtime/generated/explain-him-native-skill.mjs': "Generated by tools/generate_native_skill.py explain_him experimental-open-backlog fc0b3bf222ad485d82bc6a0e05a5bb6130d8cdba06b2550d4475daa265271d36",
            'tools/generate_native_skill.py': 'SOURCE_COMMIT = "59167103ebfb7d4fd0c276de7f2b81862c536b4f"\ndocument.modelContext.registerSkill experimental-open-backlog pinned-remote-fallback',
            'explain-him.yaml': 'repository: andrew-veresov/explain-him\nentrypoint: skills/explain-him/SKILL.md\nentrypoint: skills/explain-him-presentation/SKILL.md\nrelease: A8\nnative_skill:\n  proposal_status: experimental-open-backlog\n  composite_sha256: fc0b3bf222ad485d82bc6a0e05a5bb6130d8cdba06b2550d4475daa265271d36\ngroundingSourceIndex:\n  topic: originator-publishing\n  path: knowledge/01-originator-flow.md\n  path: PRODUCT-CONTRACT.md\n  sha256: 24acbad739ead8781ad2918a227e5670ca9bdbf464088e5de530a29ae63a1c3c\nstate_model: transactional-typed-presentation-operation-log\n- get_explain_him_context\n- explain_tool\n',
            'schemas/explanation-block.v1.schema.json': '{}',
            'schemas/webmcp-context.v4.schema.json': '{}',
            'schemas/webmcp-explain.v4.schema.json': '{}',
