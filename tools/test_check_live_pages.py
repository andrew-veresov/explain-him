...
class LivePagesSmokeTest(unittest.TestCase):
    def materialize(self, root: Path, extra_root: str = '') -> None:
        content = {
            'index.html': f'<head>{CANONICAL_TRIAL_META}</head><meta name="explain-him-repository" content="andrew-veresov/explain-him"><meta name="explain-him-skill" content="skills/explain-him/SKILL.md"><meta name="explain-him-presentation-skill" content="skills/explain-him-presentation/SKILL.md"><script type="application/json">054bbf4e4c2f121bf6066ef7d1ae961c7c7a0aef groundingSourceIndex knowledge/01-originator-flow.md cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md accf552b100c1acdd056f166e26c1579f0b55048bc4c67b35f16272af344f4d7</script><nav><a data-scroll-section="how-it-works">How it works</a><a data-scroll-section="how-to-express">How to express your idea</a></nav><section data-eh-block-id="workflow-diagram"></section><aside>Ask your agent how to express your own idea with Explain Him.</aside><script src="assets/app.mjs"></script>' + extra_root,
            'PRODUCT-CONTRACT.md': '# Explain Him Product Contract\n\n## Authoring and publishing reality\n\nExplain Him does not currently define a dedicated authoring editor. GitHub Pages is a publication surface.\n',
            ...
            'runtime/webmcp.mjs': "explain-him-webmcp-contract.v3 get_explanation_contract apply_explanation IMMUTABLE_SKILL_PROOF 054bbf4e4c2f121bf6066ef7d1ae961c7c7a0aef GROUNDING_SOURCE_INDEX originator-publishing cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md accf552b100c1acdd056f166e26c1579f0b55048bc4c67b35f16272af344f4d7 repositoryRetrievalRequiredWhenPageInsufficient decisionPrecedence terminologyConsistency name: 'get_explanation_contract' name: 'apply_explanation' workflow-diagram",
            ...
            'knowledge/01-originator-flow.md': '# Originator flow\n\n## Basic flow\n\nPublish the repository or GitHub Pages link.\n\nstatus: current\n',
