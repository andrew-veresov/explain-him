...
class LivePagesSmokeTest(unittest.TestCase):
    def materialize(self, root: Path, extra_root: str = '') -> None:
        content = {
            'index.html': f'<head>{CANONICAL_TRIAL_META}</head><meta name="explain-him-repository" content="andrew-veresov/explain-him"><meta name="explain-him-skill" content="skills/explain-him/SKILL.md"><meta name="explain-him-presentation-skill" content="skills/explain-him-presentation/SKILL.md"><script type="application/json">e7da9515f5ea444b5919a99477bcbc8e56e03edd groundingSourceIndex knowledge/01-originator-flow.md cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md 0df8585ee8293165b936d803eb095bba19e62a32fbd7745db284003ef78b4006</script><nav><a data-scroll-section="how-it-works">How it works</a><a data-scroll-section="how-to-express">How to express your idea</a></nav><section data-eh-block-id="workflow-diagram"></section><aside>Ask your agent how to express your own idea with Explain Him.</aside><script src="assets/app.mjs"></script>' + extra_root,
            ...
            'runtime/webmcp.mjs': "explain-him-webmcp-contract.v3 get_explain_him_answer apply_explanation IMMUTABLE_SKILL_PROOF e7da9515f5ea444b5919a99477bcbc8e56e03edd GROUNDING_SOURCE_INDEX originator-publishing cf7a396231a50a18c37a9c52ddc7c7315c07cf4107b6dea524760eaa630f3659 PRODUCT-CONTRACT.md 0df8585ee8293165b936d803eb095bba19e62a32fbd7745db284003ef78b4006 repositoryRetrievalRequiredWhenPageInsufficient decisionPrecedence terminologyConsistency name: 'get_explain_him_answer' name: 'apply_explanation' workflow-diagram",
