...
class OriginTrialCheckTest(unittest.TestCase):
    ...
    def test_native_chrome_gate_uses_imperative_execute_tool_not_descriptor_execute(self) -> None:
        ...
        self.assertIn("contract does not expose workflow-diagram", native_gate)
        self.assertIn("replace did not advance workspace revision", native_gate)
        ...
        self.assertIn("explain-him-webmcp-contract.v3", native_gate)
