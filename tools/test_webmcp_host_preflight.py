...
class HostPreflightTest(unittest.TestCase):
    ...
    def test_page_api_and_registration_are_separate_gates(self) -> None:
        ...
        self.assertEqual(classify_preflight({**BASE, "registered_tools": []})["code"], "PAGE_TOOLS_NOT_REGISTERED")

    def test_absent_agent_capability_is_blocked_external(self) -> None:
        result = classify_preflight({**BASE, "agent_connection_observed": False, "explain_succeeded": False})
    ...
    def test_missing_required_explain_fails(self) -> None:
    ...
    def test_explicit_opt_out_requires_no_page_tool(self) -> None:
